    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">We value your feedback and are committed to providing the best possible customer service. Please don't hesitate to get in touch with us using the form below.</p>
